        ...
        explanation: [
            {
                ...
                element: "Contexte d’utilisation",
                content: `
                    L'achèvement de mes deux ans et demi d'études a coïncidé avec l'opportunité de débuter un stage de six mois chez Holis Consulting, une startup spécialisée dans le développement frontend d'applications web avec React. Avec une expérience principalement en Angular, j'ai pris l'initiative d'apprendre React durant les vacances précédant mon stage, m'équipant des compétences nécessaires pour une transition fluide.
                    <br/><br/>
                    Mon autodidaxie a porté ses fruits, me permettant de m'immerger rapidement dans le projet ISIS dès le deuxième jour de mon stage. Ma capacité à m'adapter et à comprendre les nuances de React a été rapidement reconnue par Holis Consulting, qui a partagé ces impressions positives avec mon école lors d'un suivi de stage.
                    <br/><br/>
                    Deux mois plus tard, avec la livraison réussie d'ISIS, j'ai entamé le développement de Premis, une nouvelle aventure qui m'a confié la conception de l'architecture frontend. Ce projet m'a permis de travailler de manière autonome, développant des fonctionnalités variées et parfois complexes, des Workers pour optimiser les performances, aux composants réutilisables pour minimiser la redondance du code tout en passant par le développement de fonctionnalités classiques et courantes au sein d’applications web. La gestion de volumes de données massifs a été un défi particulier, exigeant une programmation astucieuse pour exploiter pleinement les capacités de React et assurer une performance optimale de l'application.
                    <br/><br/>
                    Parallèlement, mon projet personnel YourNight m'a donné l'occasion d'approfondir ma maîtrise de React à travers l'utilisation de React Native. Cette expérience en solitaire a renforcé ma confiance et mes capacités sur React, me permettant de naviguer avec aisance entre les applications web et mobiles grâce à ces technologies étroitement liées.
                `,
                illustration: "/images/projects/yournight.png"
            },{
                element: "Regard critique",
                content: `
                    Ma maîtrise de React, bien qu'ayant des bases solides, reconnaît une marge de progression, en particulier dans l'optimisation des performances des applications. L'efficacité avec laquelle j'ai su intégrer React à mon arsenal de compétences, démontrée par ma rapide adaptation lors du projet ISIS chez Holis Consulting, témoigne d'une capacité d'apprentissage qui a été reconnue par mon entreprise elle-même. Cependant, en tant qu'autocritique constructive, je reconnais le besoin constant de me perfectionner, surtout dans les aspects avancés comme le state management et le rendering conditionnel complexe.
                `,
                illustration: "/images/projects/yournight.png"
            },{
                element: "Evolution",
