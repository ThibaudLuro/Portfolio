        ...
        explanation: [
            {
                ...
                content: `
                    ...
                    <br/><br/>
                    La création d'une <b>charte graphique</b> évoquant l'atmosphère nocturne et festive, la <b>conception d'une interface</b> intuitive, la réalisation d'une application facile à utiliser tout en ayant <b>défini les technologies</b> utiles à son développement au préalable, avant de finalement mener une <a>campagne marketing</a> pour convaincre puis fidéliser de nouveaux utilisateurs en France.
                    <br/><br/>
        ...
        explanation: [
            {
                ...
                content: `
                    ...
                    <br/><br/>
                    <b>J'ai en personne choisi le format Blitz</b> pour le tournoi, un mode de jeu rapide et populaire aux échecs, où chaque joueur dispose d'un temps limité de trois minutes pour l'ensemble de la partie. Ce format est idéal pour un tournoi en ligne car il permet de jouer de nombreuses parties en un temps réduit, rendant le tournoi dynamique et captivant. Le prix d'entrée a été fixé à trois euros, un montant accessible pour encourager une large participation.
                    <br/><br/>
                    ...
                    <br/><br/>
                    La transparence était également un aspect clé de notre gestion financière. Nous nous sommes assurés que toutes les parties prenantes, y compris nos partenaires et les participants au tournoi, étaient informés de la manière dont les fonds étaient utilisés à l’aide de documents nous ayant été fournis par l’UNICEF. Cette approche a renforcé la confiance dans notre gestion du projet et a souligné notre engagement envers la responsabilité et l'intégrité.
                    `,
            }, {
                element: "Résultat",
                content: `
                ...
                <br/><br/>
                L'une des principales raisons de cette participation limitée a été la date de l'événement, qui coïncidait avec la fin du confinement et le début de l'été. Cette période a probablement incité de nombreuses personnes à privilégier d'autres activités après une longue période de restrictions. Bien que conscient de ce possible obstacle, <b>notre équipe était contrainte par le calendrier académique</b>, qui stipulait que le tournoi soit organisé et évalué avant la fin du semestre.
                <br/><br/>
                ...
                <br/><br/>
                En conclusion, bien que Mat' moi ça n'ait pas été poursuivi, les compétences que j'ai développées grâce à ce projet comme la <b>Communication Digitale</b>, <b>négociation</b>, <b>relations professionnelles</b> et <b>Gestion de Budget</b>, sont des atouts précieux. Ces compétences me seront utiles dans tous mes projets futurs, me permettant de naviguer avec succès dans divers environnements professionnels et de mener à bien des initiatives ambitieuses.
                    `,
            }, {
                element: "Compétences liées",
        ...
        explanation: [
            {
                ...
                <br/><br/>
                Pour mener à bien ce projet, nous avons adopté la méthode de <a>Gestion de Projet Agile et Scrum</a>, une approche agile de gestion de projet qui favorise la flexibilité, la collaboration et l'adaptation rapide aux changements. L'une des premières étapes clés a été la réunion de lancement avec le <b>Product Owner</b>, au cours de laquelle nous avons défini l'ensemble des <b>User Stories</b> du projet. Ces User Stories représentaient les différentes fonctionnalités et exigences que notre application devait satisfaire, et leur définition claire a été essentielle pour orienter notre travail de développement.
                <br/><br/>
