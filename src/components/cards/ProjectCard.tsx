...
export default function ProjectCard(props: IProps) {
    return (
        <div className={`group h-80 flex flex-col justify-center items-center cursor-pointer bg-neutral-300 hover:bg-neutral-400 hover:shadow-xl transition duration-300 ease-in-out ${props.colSpan && `md:col-span-${props.colSpan.toString()}`}`}>
