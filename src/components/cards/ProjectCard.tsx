...
export default function ProjectCard(props: IProps) {
    return (
        <div className={`group h-80 flex flex-col justify-center items-center cursor-pointer bg-zinc-300 hover:bg-zinc-400 hover:shadow-xl transition duration-300 ease-in-out ${props.colSpan && `md:col-span-${props.colSpan.toString()}`}`}>
